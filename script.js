...
function fetchFX() {
  fetch('https://v6.exchangerate-api.com/v6/7b06deec245c4dd4f5f5f147/latest/USD')
    ...
    .then(function(r) {
      ...
      if (!el) return;
      el.innerHTML = '<div class="fx-card"><div><div class="fx-title">💱 ' + (lang === 'es' ? 'Tipo de Cambio' : 'Exchange Rate') + '</div>'
        + '<div class="fx-rates">'
        + '<div class="fx-rate"><div class="fx-label">1 USD</div><div class="fx-value">' + mxn.toFixed(2) + '<span class="fx-unit"> MXN</span></div></div>'
        + '<div class="fx-rate"><div class="fx-label">1 MXN</div><div class="fx-value">' + (1/mxn).toFixed(4) + '<span class="fx-unit"> USD</span></div></div>'
        + '</div></div>'
